社員{employee}: [社員ID], 社員番号{employee_number:string@}, 氏名{name:string!}, フリガナ{name_kana:string}, メール{email:string@}, 電話{phone:string}, 住所{address:string}, 誕生日{birthday:datetime}, 入社日{hire_date:datetime!}, 退職日{resignation_date:datetime}, 基本給{base_salary:int}, ステータス{status:string!}, 作成日時{created_at:datetime!}
