...
発注{purchase_order}: [発注ID{id:int}], (仕入先ID{nonexistent_supplier_id:int}), 発注日{order_date:datetime!}, 希望納期{requested_delivery_date:datetime}, 合計金額{total_amount:int!}, ステータス{status:string!}, 作成者{created_by:string}, 承認者{approved_by:string}
